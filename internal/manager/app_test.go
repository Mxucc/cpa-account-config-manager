...
func TestManagementRegistrationUsesExactFixedRoutes(t *testing.T) {
	...
	expected := map[string]struct{}{
		...
		http.MethodPost + " /plugins/cpa-account-config-manager/ai-providers/usage-limits":                  {},
		http.MethodPut + " /plugins/cpa-account-config-manager/ai-providers/usage-limits":                   {},
