const operatorMessages: Record<string, string> = {
  ...
  "no file-backed accounts match the current filters": "当前筛选没有可导出的文件型账号",
  "no compatible Codex OAuth accounts match the current filters": "当前筛选没有兼容的 Codex OAuth 账号",
