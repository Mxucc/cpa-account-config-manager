export const enUI = {
  ...
  "ui.opencode_tab_cline_pass": "Cline Pass",
  "ui.opencode_cline_pass_accounts": "Cline Pass accounts",
  "ui.opencode_cline_pass_description": "Sign in with the browser device flow, reuse an existing Cline CLI sign-in, or paste an API key. Tokens stay in the plugin private data directory and are never returned to the browser.",
  "ui.opencode_cline_pass_login_device": "Sign in with browser",
  "ui.opencode_cline_pass_login_cli": "Use existing Cline CLI sign-in",
  "ui.opencode_cline_pass_login_api_key": "Save API key",
  "ui.opencode_cline_pass_code": "Enter this code at {url}",
  "ui.opencode_cline_pass_open_browser": "Open the sign-in page",
  "ui.opencode_cline_pass_waiting": "Waiting for the browser sign-in to complete…",
  "ui.opencode_cline_pass_login_ok": "Cline Pass account signed in",
  "ui.opencode_cline_pass_login_failed": "Cline Pass sign-in failed: {error}",
  "ui.opencode_cline_pass_login_expired": "The sign-in code expired. Start again.",
  "ui.opencode_cline_pass_cancel": "Cancel sign-in",
  "ui.opencode_cline_pass_api_key_label": "Cline Pass API key",
  "ui.opencode_cline_pass_name_label": "Account name (optional)",
  "ui.opencode_cline_pass_token_state": "Tokens",
  "ui.opencode_cline_pass_token_ready": "Access and refresh",
  "ui.opencode_cline_pass_token_missing": "Missing",
  "ui.opencode_cline_pass_expires": "Expires {time}",
  "ui.opencode_cline_pass_expired": "Expired",
  "ui.opencode_cline_pass_refresh": "Refresh sign-in",
  "ui.opencode_cline_pass_refreshed": "Cline Pass token refreshed",
  "ui.opencode_cline_pass_auth_oauth": "OAuth",
  "ui.opencode_cline_pass_auth_api_key": "API key",
  "ui.opencode_cline_pass_auth_cli": "Cline CLI",
  "ui.opencode_cline_pass_bound": "Cline Pass channel published",
  "ui.opencode_cline_pass_routing": "Routing",
  "ui.opencode_cline_pass_routing_bound": "Bound · {count} models published",
  "ui.opencode_cline_pass_routing_gaps": "{count} models are not published",
  "ui.opencode_cline_pass_routing_unbound": "Not bound to a CPA channel",
  "ui.opencode_cline_pass_routing_hint": "Until the account is bound, clients calling these models get \"unknown provider for model\".",
  "ui.opencode_cline_pass_binding_error": "Cline Pass channel was not bound: {error}",
  "ui.opencode_cline_pass_no_accounts": "No Cline Pass accounts yet.",
  "ui.opencode_cline_pass_tab_accounts": "Accounts",
  "ui.opencode_cline_pass_tab_models": "Models",
  ...
  "ui.opencode_cline_pass_upstream_id": "Upstream id",
  "ui.opencode_cline_pass_published": "Published",
  "ui.opencode_cline_pass_unpublished": "Not published",
  "ui.opencode_cline_pass_models_summary": "{published} of {total} models published",
  "ui.opencode_cline_pass_models_empty": "The Cline Pass gateway returned no models for this account.",
  "ui.opencode_cline_pass_models_no_account": "No Cline Pass account yet. Sign in first, then bind the channel.",
  "ui.opencode_cline_pass_models_error": "The Cline Pass model mapping could not be loaded: {error}",
  "ui.opencode_cline_pass_settings_error": "The Cline Pass prefix setting could not be saved: {error}",
  "ui.opencode_cline_pass_usage": "Usage and reference prices",
  "ui.opencode_cline_pass_usage_tokens": "This month: {input} input / {output} output tokens · {requests} requests",
  "ui.opencode_cline_pass_usage_reference": "{reference} reference price / {subscription} subscription",
  "ui.opencode_cline_pass_usage_reference_note": "These USD totals are reference prices at the rates Cline documents for the standard API, not an amount you are charged. A Cline Pass subscription is a flat monthly fee.",
  "ui.opencode_cline_pass_usage_window_title": "{window}: {usd} reference price · input {input} / output {output} tokens · {requests} requests",
  "ui.opencode_cline_pass_models_prices_note": "Documented reference rates in USD per million tokens: what the same usage would cost at the standard API rates, not an amount you are charged.",
