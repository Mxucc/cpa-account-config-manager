export const enUI = {
  ...
  "ui.codex_ingress_gate_description": "This global switch is the master control. When enabled, accounts flagged with codex_cli_only are denied before upstream using blacklist, whitelist, version bounds, and engine fingerprints. When disabled, the plugin stops rejecting any account even if that flag is still set (the host may still restrict it), and an explicit per-account or per-provider policy can override either way.",
