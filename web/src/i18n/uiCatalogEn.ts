export const enUI = {
  ...
  "ui.overdraft_usage_window_observed": "{label} observed overdraft: {tokens} tokens across {requests} successful requests (official total {total}%)",
  "ui.overdraft_tokens_value": "{count} tok",
  "ui.overdraft_requests_value": "{count} requests",
  "ui.overdraft_usage_included_in_total": "When the official value exceeds 100%, its percentage is shown. When upstream remains capped at 100%, successful request tokens observed after exhaustion are shown instead. The 5h and 7d windows are measured separately.",
