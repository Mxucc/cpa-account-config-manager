export const enUI = {
  ...
  "ui.codex_agent_identity_description": "Authenticate Codex through signed AgentAssertion credentials imported from official JWT, object JSON, or Sub2API exports.",
  "ui.authentication_path": "Authentication path",
  "ui.agent_identity_authentication_behavior": "Only Agent Identity accounts use the plugin executor and per-request signatures. Existing Codex OAuth accounts remain unchanged.",
  "ui.supported_imports": "Supported imports",
  "ui.agent_identity_import_formats": "Official JWT credentials, codex-agent-identity-web objects, and multi-account Sub2API JSON or ZIP exports.",
  "ui.security_notice": "Security notice",
  "ui.agent_identity_security_notice": "Identity files contain a private signing key and task ID. Import only trusted files; previews and logs never expose these values.",
  ...
  "ui.external_notifications_description": "Send one aggregate GET notification after a scheduled inspection when account-pool availability conditions are met",
