export const enUI = {
  ...
  "ui.weekly_overdraft_automation_behavior": "After the seven-day quota is exhausted, inspection runs up to five experimental probes. Any success keeps the account enabled; five failures allow auto-disable, followed by recovery at the weekly reset when auto-enable is on.",
  ...
  "ui.weekly_overdraft_probe_gate": "Weekly overdraft probe",
  ...
  "ui.notification_delivery_policy": "Trigger policy",
  "ui.notification_delivery_policy_number": "Trigger policy for endpoint {number}",
  "ui.generic_notification": "Generic notification",
  ...
  "ui.add_notification_policy": "Add notification policy",
  ...
  "ui.confirm_remove_notification_policy": "Delete notification policy {name}? Bound endpoints will return to generic notifications.",
  ...
  "ui.notification_policy_binding_invalid": "A notification endpoint references a policy that no longer exists",
  "ui.generic_notification_endpoint_required": "Enable at least one generic endpoint for generic notification triggers",
  "ui.policy_notification_endpoint_required": "Enable and bind at least one endpoint before enabling a notification policy",
  "ui.policy_notification_endpoint_required_named": "Enable and bind an endpoint for notification policy {name}",
  "ui.notification_policy_order_hint": "Policy order is for organization only; all matching policies evaluate independently.",
  "ui.save_notification_policy_before_testing": "Save this notification policy and endpoint binding before previewing or testing it",
  ...
  "ui.notification_parameter_policy_id": "Notification policy ID",
