export const enUI = {
  ...
  "ui.codex_auto_model_whitelist_description": "Detect the restricted ChatGPT-account model set during a manual model test and apply an account allow-list.",
  ...
  "ui.auto_model_whitelist_safety_notice": "Off by default. Model-specific failures never disable the whole account, whether this experiment is on or off.",
  ...
  "ui.codex_weekly_quota_overdraft": "Codex weekly-quota continuation",
  ...
  "ui.weekly_overdraft_request_behavior": "Only Codex request bodies are considered. Invalid, oversized, non-user, and already injected requests pass through unchanged.",
  "ui.automation_behavior": "Automation behavior",
  "ui.weekly_overdraft_automation_behavior": "Weekly-quota auto-disable is suspended while enabled. Five-hour limits, invalid credentials, and deactivated accounts keep their normal remediation.",
  ...
  "ui.notification_test_scenario": "Notification test scenario",
  "ui.notification_scenario_manual": "Manual test",
  "ui.notification_scenario_anomaly": "Anomaly ratio",
  "ui.notification_scenario_available_accounts": "Available count",
  "ui.notification_scenario_availability_percent": "Availability rate",
  "ui.notification_scenario_combined": "Combined",
  ...
  "ui.plugin_version_installed_refresh_to_use_the_new_version": "Plugin {version} installed; refresh to use the new version",
	 "ui.native_plugin_update_requires_a_full_cpa_restart": "Native plugin updates require a full CPA restart; refreshing the page or deleting the old file does not stop an instance already loaded in memory",
	 ...
	 "ui.restart_cpa_to_enable_this_plugin_instance_s_background_automation": "This fixed release is waiting for its first CPA restart; it will not start new inspections, automatic actions, or external notifications before then",
