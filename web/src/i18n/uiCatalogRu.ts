...
export const ruUI: Record<UIMessageKey, string> = {
  ...
  "ui.codex_quota_metadata_probe": "Проверка тарифа и сбросов Codex",
  "ui.codex_quota_metadata_probe_description": "Обновлять тариф Codex и число активных сбросов до сопоставления условных политик",
  "ui.enable_codex_quota_metadata_probe": "Включить проверку тарифа и сбросов Codex",
  "ui.quota_metadata_probe_summary": "Последняя проверка: обновлено {updated}/{probed} · ошибок {failed}",
  "ui.always_enabled": "Всегда включено",
