...
export const ruUI: Record<UIMessageKey, string> = {
  ...
  "ui.weekly_overdraft_automation_behavior": "После исчерпания семидневной квоты проверка выполняет до пяти экспериментальных запросов. Любой успешный запрос оставляет аккаунт включённым; пять неудач разрешают автоотключение с восстановлением после сброса квоты, если включено автовключение.",
  ...
  "ui.weekly_overdraft_probe_gate": "Проверка недельного перерасхода",
  ...
  "ui.notification_delivery_policy": "Политика запуска",
  "ui.notification_delivery_policy_number": "Политика запуска для адреса {number}",
  "ui.generic_notification": "Общее уведомление",
  ...
  "ui.add_notification_policy": "Добавить политику",
  ...
  "ui.confirm_remove_notification_policy": "Удалить политику {name}? Связанные адреса вернутся к общим уведомлениям.",
  ...
  "ui.notification_policy_binding_invalid": "Адрес уведомления ссылается на удалённую политику",
  "ui.generic_notification_endpoint_required": "Для общих уведомлений включите хотя бы один адрес в общем режиме",
  "ui.policy_notification_endpoint_required": "Перед включением политики включите и свяжите хотя бы один адрес",
  "ui.policy_notification_endpoint_required_named": "Включите и свяжите адрес для политики уведомлений {name}",
  "ui.notification_policy_order_hint": "Порядок нужен только для управления; все совпавшие политики проверяются независимо.",
  "ui.save_notification_policy_before_testing": "Сохраните политику и привязку адреса перед предварительным просмотром или тестом",
  ...
  "ui.notification_parameter_policy_id": "ID политики уведомлений",
