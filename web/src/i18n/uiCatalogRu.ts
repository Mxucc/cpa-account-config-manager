...
export const ruUI: Record<UIMessageKey, string> = {
  ...
  "ui.opencode_go_accounts_description": "ID рабочего пространства и cookie auth дают квоту; API-ключ нужен для каталога моделей, теста модели и маршрутизации CPA.",
