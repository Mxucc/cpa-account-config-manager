...
export const ruUI: Record<UIMessageKey, string> = {
  ...
  "ui.github_releases_and_the_cpa_plugin_store": "GitHub Releases и магазин плагинов CPA",
  ...
  "ui.github_metadata_unavailable_using_plugin_store": "Метаданные GitHub недоступны; используется версия из магазина плагинов CPA",
  ...
  "ui.probe_manually_disabled_accounts": "Проверять отключенные вручную аккаунты",
  ...
  "ui.full_inspection": "Полная проверка",
