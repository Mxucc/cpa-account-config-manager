...
export const ruUI: Record<UIMessageKey, string> = {
  ...
  "ui.opencode_tab_cline_pass": "Учётные записи Cline Pass",
  "ui.opencode_cline_pass_accounts": "Учётные записи Cline Pass",
  "ui.opencode_cline_pass_description": "Войдите через браузер по коду устройства, используйте существующий вход Cline CLI или вставьте API-ключ. Токены хранятся в приватном каталоге плагина и никогда не возвращаются в браузер.",
  "ui.opencode_cline_pass_login_device": "Войти через браузер",
  "ui.opencode_cline_pass_login_cli": "Использовать вход Cline CLI",
  "ui.opencode_cline_pass_login_api_key": "Сохранить API-ключ",
  "ui.opencode_cline_pass_code": "Введите этот код на {url}",
  "ui.opencode_cline_pass_open_browser": "Открыть страницу входа",
  "ui.opencode_cline_pass_waiting": "Ожидание завершения входа в браузере…",
  "ui.opencode_cline_pass_login_ok": "Учётная запись Cline Pass подключена",
  "ui.opencode_cline_pass_login_failed": "Не удалось войти в Cline Pass: {error}",
  "ui.opencode_cline_pass_login_expired": "Срок действия кода входа истёк. Начните заново.",
  "ui.opencode_cline_pass_cancel": "Отменить вход",
  "ui.opencode_cline_pass_api_key_label": "API-ключ Cline Pass",
  "ui.opencode_cline_pass_name_label": "Имя учётной записи (необязательно)",
  "ui.opencode_cline_pass_token_state": "Токены",
  "ui.opencode_cline_pass_token_ready": "Доступ и обновление",
  "ui.opencode_cline_pass_token_missing": "Отсутствуют",
  "ui.opencode_cline_pass_expires": "Истекает {time}",
  "ui.opencode_cline_pass_expired": "Истёк",
  "ui.opencode_cline_pass_refresh": "Обновить вход",
  "ui.opencode_cline_pass_refreshed": "Токен Cline Pass обновлён",
  "ui.opencode_cline_pass_auth_oauth": "OAuth",
  "ui.opencode_cline_pass_auth_api_key": "API-ключ",
  "ui.opencode_cline_pass_auth_cli": "Cline CLI",
  "ui.opencode_cline_pass_bound": "Канал Cline Pass опубликован",
  "ui.opencode_cline_pass_routing": "Маршрутизация",
  "ui.opencode_cline_pass_routing_bound": "Привязано · моделей опубликовано: {count}",
  "ui.opencode_cline_pass_routing_gaps": "Не опубликовано моделей: {count}",
  "ui.opencode_cline_pass_routing_unbound": "Не привязано к каналу CPA",
  "ui.opencode_cline_pass_routing_hint": "Пока учётная запись не привязана, клиенты получают ошибку \"unknown provider for model\".",
  "ui.opencode_cline_pass_binding_error": "Не удалось привязать канал Cline Pass: {error}",
  "ui.opencode_cline_pass_no_accounts": "Учётных записей Cline Pass пока нет.",
  "ui.opencode_cline_pass_tab_accounts": "Аккаунты",
  "ui.opencode_cline_pass_tab_models": "Модели",
  ...
  "ui.opencode_cline_pass_upstream_id": "ID вышестоящей модели",
  "ui.opencode_cline_pass_published": "Опубликована",
  "ui.opencode_cline_pass_unpublished": "Не опубликована",
  "ui.opencode_cline_pass_models_summary": "Опубликовано моделей: {published} из {total}",
  "ui.opencode_cline_pass_models_empty": "Шлюз Cline Pass не вернул ни одной модели для этой учётной записи.",
  "ui.opencode_cline_pass_models_no_account": "Учётной записи Cline Pass пока нет. Сначала войдите, затем привяжите канал.",
  "ui.opencode_cline_pass_models_error": "Не удалось загрузить сопоставление моделей Cline Pass: {error}",
  "ui.opencode_cline_pass_settings_error": "Не удалось сохранить настройку префикса Cline Pass: {error}",
  "ui.opencode_cline_pass_usage": "Использование и справочные цены",
  "ui.opencode_cline_pass_usage_tokens": "За месяц: ввод {input} / вывод {output} токенов · {requests} запросов",
  "ui.opencode_cline_pass_usage_reference": "Справочная цена {reference} / подписка {subscription}",
  "ui.opencode_cline_pass_usage_reference_note": "Эти суммы в USD — справочные цены по опубликованным стандартным тарифам API Cline, а не фактическая плата. Подписка Cline Pass — фиксированная месячная плата.",
  "ui.opencode_cline_pass_usage_window_title": "{window}: справочная цена {usd} · ввод {input} / вывод {output} токенов · {requests} запросов",
  "ui.opencode_cline_pass_models_prices_note": "Опубликованные справочные тарифы в USD за миллион токенов: справочная цена того же объёма по стандартным тарифам API, а не фактическая плата.",
