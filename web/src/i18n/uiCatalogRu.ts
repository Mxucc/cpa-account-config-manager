...
export const ruUI: Record<UIMessageKey, string> = {
  ...
  "ui.overdraft_usage_window_observed": "Наблюдаемый перерасход {label}: {tokens} токенов в {requests} успешных запросах (официальное использование {total}%)",
  "ui.overdraft_tokens_value": "{count} ток.",
  "ui.overdraft_requests_value": "{count} запросов",
  "ui.overdraft_usage_included_in_total": "Если официальное значение превышает 100%, показывается процент. Если вышестоящий сервис оставляет значение на уровне 100%, показываются токены успешных запросов после исчерпания квоты. Окна 5 ч и 7 дн учитываются отдельно.",
