...
export const ruUI: Record<UIMessageKey, string> = {
  ...
  "ui.inspection_run_status": "Состояние запуска проверки",
  ...
  "ui.ai_provider_channels": "Каналы",
  "ui.ai_provider_credentials": "Учётные данные",
  ...
  "ui.refreshing_data": "Обновление данных",
  "ui.observed_at": "Наблюдение {time}",
  "ui.active_requests": "Активные запросы",
  "ui.health_distribution": "Распределение состояния",
  "ui.request_activity": "Активность запросов",
  "ui.usage_windows": "Окна использования",
  "ui.inspection_timeline": "Хронология проверок",
  "ui.needs_attention": "Требует внимания",
  "ui.success_requests": "Успешные запросы",
  "ui.no_data_collected": "Данные ещё не собраны",
  "ui.not_available": "Недоступно",
  "ui.codex_five_hour": "Codex · окно 5 часов",
  "ui.codex_seven_day": "Codex · окно 7 дней",
  "ui.used_percent": "Использовано {percent}%",
  "ui.request_activity_summary": "{success} успешных · {failed} неуспешных",
  "ui.inspection_run_summary": "{scanned} проверено · {failed} ошибок",
  "ui.no_attention_items": "Сейчас нет задач для обработки",
  "ui.no_active_requests": "Нет активных запросов",
