...
export const ruUI: Record<UIMessageKey, string> = {
  ...
  "ui.codex_auto_model_whitelist_description": "Определяет ограниченный набор моделей аккаунта ChatGPT во время ручной проверки и применяет список разрешённых моделей.",
  ...
  "ui.auto_model_whitelist_safety_notice": "По умолчанию выключено. Ошибка отдельной модели никогда не отключает весь аккаунт независимо от состояния эксперимента.",
  ...
  "ui.codex_weekly_quota_overdraft": "Продолжение после недельной квоты Codex",
  ...
  "ui.weekly_overdraft_request_behavior": "Обрабатываются только тела запросов Codex. Некорректные, слишком большие, уже изменённые запросы и запросы без сообщения пользователя в конце передаются без изменений.",
  "ui.automation_behavior": "Автоматизация",
  "ui.weekly_overdraft_automation_behavior": "Автоотключение по недельной квоте приостанавливается. Пятичасовые лимиты, недействительные учётные данные и деактивированные аккаунты обрабатываются как обычно.",
  ...
  "ui.notification_test_scenario": "Сценарий теста уведомления",
  "ui.notification_scenario_manual": "Ручной тест",
  "ui.notification_scenario_anomaly": "Доля аномалий",
  "ui.notification_scenario_available_accounts": "Число доступных",
  "ui.notification_scenario_availability_percent": "Доля доступных",
  "ui.notification_scenario_combined": "Все условия",
  ...
  "ui.plugin_version_installed_refresh_to_use_the_new_version": "Плагин {version} установлен; обновите страницу для использования новой версии",
	 "ui.native_plugin_update_requires_a_full_cpa_restart": "После обновления нативного плагина требуется полный перезапуск CPA; обновление страницы или удаление старого файла не останавливает экземпляр, уже загруженный в память",
	 ...
	 "ui.restart_cpa_to_enable_this_plugin_instance_s_background_automation": "Исправленная версия ожидает первого перезапуска CPA; до него новые проверки, автоматические действия и внешние уведомления запускаться не будут",
