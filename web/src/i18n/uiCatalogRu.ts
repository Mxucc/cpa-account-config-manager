...
export const ruUI: Record<UIMessageKey, string> = {
  ...
  "ui.codex_agent_identity_description": "Аутентификация Codex подписанными учётными данными AgentAssertion из официального JWT, объектного JSON или экспорта Sub2API.",
  "ui.authentication_path": "Способ аутентификации",
  "ui.agent_identity_authentication_behavior": "Только аккаунты Agent Identity используют исполнитель плагина и подпись каждого запроса. Существующие аккаунты Codex OAuth не изменяются.",
  "ui.supported_imports": "Поддерживаемый импорт",
  "ui.agent_identity_import_formats": "Официальные JWT, объекты codex-agent-identity-web и многоаккаунтные экспорты Sub2API в JSON или ZIP.",
  "ui.security_notice": "Безопасность",
  "ui.agent_identity_security_notice": "Файл содержит закрытый ключ и идентификатор задачи. Импортируйте только доверенные файлы; эти значения не выводятся в предпросмотре и журналах.",
  ...
  "ui.external_notifications_description": "Отправлять одно сводное GET-уведомление после плановой проверки при выполнении условий доступности пула",
