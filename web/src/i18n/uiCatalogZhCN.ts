...
export const zhCNUI: Record<UIMessageKey, string> = {
  ...
  "ui.codex_quota_metadata_probe": "Codex 套餐与重置次数探测",
  "ui.codex_quota_metadata_probe_description": "在条件策略匹配前刷新 Codex 套餐和主动重置次数",
  "ui.enable_codex_quota_metadata_probe": "启用 Codex 套餐与重置次数探测",
  "ui.quota_metadata_probe_summary": "最近探测：更新 {updated}/{probed} · 失败 {failed}",
  "ui.always_enabled": "始终启用",
