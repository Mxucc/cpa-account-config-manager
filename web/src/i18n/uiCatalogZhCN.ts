...
export const zhCNUI: Record<UIMessageKey, string> = {
  ...
  "ui.github_releases_and_the_cpa_plugin_store": "GitHub Release 与 CPA 插件商店",
  ...
  "ui.github_metadata_unavailable_using_plugin_store": "GitHub 元数据不可用，已使用 CPA 插件商店版本",
  ...
  "ui.probe_manually_disabled_accounts": "巡检人工禁用账号",
