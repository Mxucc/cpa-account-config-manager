...
export const zhCNUI: Record<UIMessageKey, string> = {
  ...
  "ui.overdraft_usage_window_observed": "{label} 已观测透支 {tokens} Tokens，共 {requests} 个成功请求（官方总用量 {total}%）",
  "ui.overdraft_tokens_value": "{count} tok",
  "ui.overdraft_requests_value": "{count} 次",
  "ui.overdraft_usage_included_in_total": "官方百分比超过 100% 时显示百分比；上游固定返回 100% 时，显示插件在额度耗尽后观测到的成功请求 Token。5h 与 7d 分别计算。",
