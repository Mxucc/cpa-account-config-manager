...
export const zhCNUI: Record<UIMessageKey, string> = {
  ...
  "ui.opencode_tab_cline_pass": "Cline Pass 账号",
  "ui.opencode_cline_pass_accounts": "Cline Pass 账号",
  "ui.opencode_cline_pass_description": "可使用浏览器设备码登录、复用本机已有的 Cline CLI 登录，或粘贴 API 密钥。令牌仅保存在插件私有数据目录，不会返回浏览器。",
  "ui.opencode_cline_pass_login_device": "使用浏览器登录",
  "ui.opencode_cline_pass_login_cli": "复用已有的 Cline CLI 登录",
  "ui.opencode_cline_pass_login_api_key": "保存 API 密钥",
  "ui.opencode_cline_pass_code": "请在 {url} 输入此验证码",
  "ui.opencode_cline_pass_open_browser": "打开登录页",
  "ui.opencode_cline_pass_waiting": "正在等待浏览器完成登录…",
  "ui.opencode_cline_pass_login_ok": "Cline Pass 账号已登录",
  "ui.opencode_cline_pass_login_failed": "Cline Pass 登录失败：{error}",
  "ui.opencode_cline_pass_login_expired": "登录验证码已过期，请重新开始。",
  "ui.opencode_cline_pass_cancel": "取消登录",
  "ui.opencode_cline_pass_api_key_label": "Cline Pass API 密钥",
  "ui.opencode_cline_pass_name_label": "账号名称（可选）",
  "ui.opencode_cline_pass_token_state": "令牌",
  "ui.opencode_cline_pass_token_ready": "访问与刷新令牌",
  "ui.opencode_cline_pass_token_missing": "缺失",
  "ui.opencode_cline_pass_expires": "到期时间 {time}",
  "ui.opencode_cline_pass_expired": "已过期",
  "ui.opencode_cline_pass_refresh": "刷新登录",
  "ui.opencode_cline_pass_refreshed": "Cline Pass 令牌已刷新",
  "ui.opencode_cline_pass_auth_oauth": "OAuth",
  "ui.opencode_cline_pass_auth_api_key": "API 密钥",
  "ui.opencode_cline_pass_auth_cli": "Cline CLI",
  "ui.opencode_cline_pass_bound": "Cline Pass 渠道已发布",
  "ui.opencode_cline_pass_routing": "\u8def\u7531",
  "ui.opencode_cline_pass_routing_bound": "\u5df2\u7ed1\u5b9a \u00b7 \u5df2\u53d1\u5e03 {count} \u4e2a\u6a21\u578b",
  "ui.opencode_cline_pass_routing_gaps": "\u8fd8\u6709 {count} \u4e2a\u6a21\u578b\u672a\u53d1\u5e03",
  "ui.opencode_cline_pass_routing_unbound": "\u5c1a\u672a\u7ed1\u5b9a CPA \u6e20\u9053",
  "ui.opencode_cline_pass_routing_hint": "\u7ed1\u5b9a\u524d\uff0c\u8c03\u7528\u8fd9\u4e9b\u6a21\u578b\u7684\u5ba2\u6237\u7aef\u4f1a\u6536\u5230 \u201cunknown provider for model\u201d \u9519\u8bef\u3002",
  "ui.opencode_cline_pass_binding_error": "Cline Pass \u6e20\u9053\u7ed1\u5b9a\u5931\u8d25\uff1a{error}",
  "ui.opencode_cline_pass_no_accounts": "暂无 Cline Pass 账号。",
  "ui.opencode_cline_pass_tab_accounts": "\u8d26\u53f7",
  "ui.opencode_cline_pass_tab_models": "\u6a21\u578b",
  ...
  "ui.opencode_cline_pass_upstream_id": "\u4e0a\u6e38 ID",
  "ui.opencode_cline_pass_published": "\u5df2\u53d1\u5e03",
  "ui.opencode_cline_pass_unpublished": "\u672a\u53d1\u5e03",
  "ui.opencode_cline_pass_models_summary": "\u5df2\u53d1\u5e03 {published} / {total} \u4e2a\u6a21\u578b",
  "ui.opencode_cline_pass_models_empty": "\u7f51\u5173\u672a\u8fd4\u56de\u8be5\u8d26\u53f7\u7684\u4efb\u4f55\u6a21\u578b\u3002",
  "ui.opencode_cline_pass_models_no_account": "\u5c1a\u65e0 Cline Pass \u8d26\u53f7\u3002\u8bf7\u5148\u767b\u5f55\u5e76\u7ed1\u5b9a\u6e20\u9053\u3002",
  "ui.opencode_cline_pass_models_error": "\u65e0\u6cd5\u52a0\u8f7d Cline Pass \u6a21\u578b\u6620\u5c04\uff1a{error}",
  "ui.opencode_cline_pass_settings_error": "\u65e0\u6cd5\u4fdd\u5b58 Cline Pass \u524d\u7f00\u8bbe\u7f6e\uff1a{error}",
  "ui.opencode_cline_pass_usage": "\u7528\u91cf\u4e0e\u53c2\u8003\u4ef7",
  "ui.opencode_cline_pass_usage_tokens": "\u672c\u6708 token\uff1a\u8f93\u5165 {input} / \u8f93\u51fa {output} \u00b7 {requests} \u6b21\u8bf7\u6c42",
  "ui.opencode_cline_pass_usage_reference": "\u53c2\u8003\u4ef7 {reference} / \u8ba2\u9605 {subscription}",
  "ui.opencode_cline_pass_usage_reference_note": "\u8fd9\u4e9b USD \u91d1\u989d\u662f\u6309 Cline \u6587\u6863\u6807\u51c6 API \u4ef7\u76ee\u6298\u7b97\u7684\u53c2\u8003\u4ef7\uff0c\u5e76\u975e\u5b9e\u9645\u8ba1\u8d39\u91d1\u989d\u3002Cline Pass \u4e3a\u6bcf\u6708\u56fa\u5b9a\u8ba2\u9605\u3002",
  "ui.opencode_cline_pass_usage_window_title": "{window}\uff1a\u53c2\u8003\u4ef7 {usd} \u00b7 \u8f93\u5165 {input} / \u8f93\u51fa {output} token \u00b7 {requests} \u6b21\u8bf7\u6c42",
  "ui.opencode_cline_pass_models_prices_note": "\u6587\u6863\u516c\u5e03\u7684\u53c2\u8003\u8d39\u7387\uff08\u7f8e\u5143 / \u767e\u4e07 token\uff09\uff1a\u8868\u793a\u540c\u7b49\u7528\u91cf\u6309\u6807\u51c6 API \u4ef7\u76ee\u6298\u7b97\u7684\u53c2\u8003\u4ef7\uff0c\u5e76\u975e\u5b9e\u9645\u8ba1\u8d39\u91d1\u989d\u3002",
