...
export const zhCNUI: Record<UIMessageKey, string> = {
  ...
  "ui.usage_limits_description": "配置账号级或供应商级的额度、5 小时和 7 天限额。",
  "ui.account_usage_limits_description": "限额仅作用于账号 {scope}。",
  "ui.provider_usage_limits_description": "限额仅作用于供应商 {scope}。",
  ...
  "ui.usage_limit_account": "账号额度百分比",
  "ui.usage_limit_credit": "额度金额（USD）",
  "ui.usage_limit_window": "额度窗口",
  "ui.usage_limit_five_hour": "5 小时",
  "ui.usage_limit_seven_day": "7 天",
  "ui.usage_limit_percent": "限额百分比",
  "ui.usage_limit_amount": "限额金额",
  "ui.usage_limit_total": "总限额",
  "ui.usage_limit_total_description": "对当前作用域的全部用量应用限额。",
  "ui.usage_limit_models": "模型限额",
  "ui.usage_limit_models_description": "添加模型级限额，并选择是否计入总限额。",
  "ui.usage_limit_add_model": "添加模型",
  "ui.usage_limit_model_name": "模型名称",
  "ui.usage_limit_within_total": "计入总限额",
  "ui.usage_limit_no_models": "暂无模型级限额",
  "ui.usage_limit_credit_used": "已用额度",
  "ui.usage_limit_credit_note": "当前作用域内已观察到的成功用量。",
