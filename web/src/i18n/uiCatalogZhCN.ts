...
export const zhCNUI: Record<UIMessageKey, string> = {
  ...
  "ui.inspection_run_status": "巡检运行状态",
  ...
  "ui.ai_provider_channels": "渠道",
  "ui.ai_provider_credentials": "凭据",
  ...
  "ui.observability_console": "可观测性控制台",
  "ui.refreshing_data": "正在刷新数据",
  "ui.observed_at": "观测于 {time}",
  "ui.active_requests": "当前活动请求",
  "ui.health_distribution": "健康度分布",
  "ui.request_activity": "请求活动",
  "ui.usage_windows": "用量窗口",
  "ui.inspection_timeline": "巡检时间轴",
  "ui.needs_attention": "需要关注",
  "ui.success_requests": "成功请求",
  "ui.no_data_collected": "尚未采集到数据",
  "ui.not_available": "暂无数据",
  "ui.codex_five_hour": "Codex · 五小时窗口",
  "ui.codex_seven_day": "Codex · 七天窗口",
  "ui.used_percent": "已使用 {percent}%",
  "ui.request_activity_summary": "成功 {success} · 失败 {failed}",
  "ui.inspection_run_summary": "完成 {scanned} · 失败 {failed}",
  "ui.no_attention_items": "当前没有待处理事项",
  "ui.no_active_requests": "暂无活动请求",
