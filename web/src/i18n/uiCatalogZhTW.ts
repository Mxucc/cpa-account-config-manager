...
export const zhTWUI: Record<UIMessageKey, string> = {
  ...
  "ui.codex_quota_metadata_probe": "Codex 方案與重置次數探測",
  "ui.codex_quota_metadata_probe_description": "在條件策略比對前重新整理 Codex 方案和主動重置次數",
  "ui.enable_codex_quota_metadata_probe": "啟用 Codex 方案與重置次數探測",
  "ui.quota_metadata_probe_summary": "最近探測：更新 {updated}/{probed} · 失敗 {failed}",
  "ui.always_enabled": "始終啟用",
