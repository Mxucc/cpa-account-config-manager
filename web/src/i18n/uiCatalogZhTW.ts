...
export const zhTWUI: Record<UIMessageKey, string> = {
  ...
  "ui.codex_agent_identity_description": "透過官方 JWT、物件 JSON 或 Sub2API 匯出的簽章 AgentAssertion 憑證驗證 Codex。",
  "ui.authentication_path": "驗證路徑",
  "ui.agent_identity_authentication_behavior": "僅 Agent Identity 帳號使用外掛執行器與逐次請求簽章，現有 Codex OAuth 帳號維持不變。",
  "ui.supported_imports": "支援的匯入格式",
  "ui.agent_identity_import_formats": "支援官方 JWT 憑證、codex-agent-identity-web 物件，以及包含多帳號的 Sub2API JSON 或 ZIP 匯出。",
  "ui.security_notice": "安全提示",
  "ui.agent_identity_security_notice": "身分檔案包含私密金鑰與工作編號，請僅匯入可信檔案；預覽與日誌不會顯示這些值。",
  ...
  "ui.external_notifications_description": "排程巡檢結束後，依帳號池可用性條件傳送一則彙總 GET 通知",
