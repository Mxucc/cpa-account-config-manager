...
export const zhTWUI: Record<UIMessageKey, string> = {
  ...
  "ui.codex_ingress_gate_description": "全域開關是主開關：開啟時，對標記 codex_cli_only 的帳號在上游前以黑名單、白名單、版本範圍和引擎指紋判定並拒絕；關閉後外掛不再攔截任何帳號，即使該帳號仍帶有此標記（上游仍可能自行限制）。單一帳號或供應商可在其策略中明確覆寫。",
