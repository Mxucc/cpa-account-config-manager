...
export const zhTWUI: Record<UIMessageKey, string> = {
  ...
  "ui.usage_limits": "用量限額",
  "ui.usage_limits_description": "設定帳號級或供應商級的額度、5 小時與 7 天限額。",
  "ui.account_usage_limits_description": "限額僅套用於帳號 {scope}。",
  "ui.provider_usage_limits_description": "限額僅套用於供應商 {scope}。",
  "ui.usage_limits_enabled": "已啟用用量限額",
  "ui.usage_limits_disabled": "已停用用量限額",
  "ui.usage_limits_saved": "用量限額已儲存",
  "ui.usage_limits_updated_in_preview": "用量限額已更新至預覽",
  "ui.usage_limit_basis": "限額依據",
  "ui.usage_limit_account": "帳號額度百分比",
  "ui.usage_limit_credit": "額度金額（USD）",
  "ui.usage_limit_window": "額度視窗",
  "ui.usage_limit_five_hour": "5 小時",
  "ui.usage_limit_seven_day": "7 天",
  "ui.usage_limit_percent": "限額百分比",
  "ui.usage_limit_amount": "限額金額",
  "ui.usage_limit_total": "總限額",
  "ui.usage_limit_total_description": "對目前作用域的全部用量套用限額。",
  "ui.usage_limit_models": "模型限額",
  "ui.usage_limit_models_description": "新增模型級限額，並選擇是否計入總限額。",
  "ui.usage_limit_add_model": "新增模型",
  "ui.usage_limit_model_name": "模型名稱",
  "ui.usage_limit_within_total": "計入總限額",
  "ui.usage_limit_no_models": "尚無模型級限額",
  "ui.usage_limit_credit_used": "已用額度",
  "ui.usage_limit_credit_note": "目前作用域內已觀察到的成功用量。",
