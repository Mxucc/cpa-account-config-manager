...
export const zhTWUI: Record<UIMessageKey, string> = {
  ...
  "ui.inspection_run_status": "巡檢執行狀態",
  ...
  "ui.observability_console": "可觀測性控制台",
  "ui.refreshing_data": "正在重新整理資料",
  "ui.observed_at": "觀測於 {time}",
  "ui.active_requests": "目前活動請求",
  "ui.health_distribution": "健康度分布",
  "ui.request_activity": "請求活動",
  "ui.usage_windows": "用量視窗",
  "ui.inspection_timeline": "巡檢時間軸",
  "ui.needs_attention": "需要關注",
  "ui.success_requests": "成功請求",
  "ui.no_data_collected": "尚未採集到資料",
  "ui.not_available": "暫無資料",
  "ui.codex_five_hour": "Codex · 五小時視窗",
  "ui.codex_seven_day": "Codex · 七天視窗",
  "ui.used_percent": "已使用 {percent}%",
  "ui.request_activity_summary": "成功 {success} · 失敗 {failed}",
  "ui.inspection_run_summary": "完成 {scanned} · 失敗 {failed}",
  "ui.no_attention_items": "目前沒有待處理事項",
  "ui.no_active_requests": "暫無活動請求",
