...
export const zhTWUI: Record<UIMessageKey, string> = {
  ...
  "ui.overdraft_usage_window_observed": "{label} 已觀測透支 {tokens} Tokens，共 {requests} 個成功請求（官方總用量 {total}%）",
  "ui.overdraft_tokens_value": "{count} tok",
  "ui.overdraft_requests_value": "{count} 次",
  "ui.overdraft_usage_included_in_total": "官方百分比超過 100% 時顯示百分比；上游固定回傳 100% 時，顯示外掛在額度耗盡後觀測到的成功請求 Token。5h 與 7d 分別計算。",
