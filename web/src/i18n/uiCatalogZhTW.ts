...
export const zhTWUI: Record<UIMessageKey, string> = {
  ...
  "ui.codex_auto_model_whitelist_description": "在手動模型測試中辨識受限的 ChatGPT 帳號模型集合，並為該帳號套用白名單。",
  ...
  "ui.auto_model_whitelist_safety_notice": "預設關閉。無論是否啟用實驗，單一模型失敗都不會停用整個帳號。",
  ...
  "ui.codex_weekly_quota_overdraft": "Codex 每週額度透支續用",
  "ui.codex_weekly_quota_overdraft_description": "當 Codex 輸入最後一項是使用者訊息時，在送往上游前加入一組相關聯的無操作工具呼叫與輸出。",
  "ui.request_behavior": "請求行為",
  "ui.weekly_overdraft_request_behavior": "僅處理 Codex 請求本文；無效、過大、非使用者結尾或已注入的請求均原樣放行。",
  "ui.automation_behavior": "自動化行為",
  "ui.weekly_overdraft_automation_behavior": "啟用後暫停每週額度耗盡的自動停用；5 小時額度、憑證失效與帳號停用仍依原策略處置。",
  ...
  "ui.notification_test_scenario": "通知測試場景",
  "ui.notification_scenario_manual": "手動測試",
  "ui.notification_scenario_anomaly": "異常占比",
  "ui.notification_scenario_available_accounts": "可用帳號數",
  "ui.notification_scenario_availability_percent": "帳號可用率",
  "ui.notification_scenario_combined": "組合場景",
  ...
  "ui.plugin_version_installed_refresh_to_use_the_new_version": "外掛程式 {version} 已安裝，重新整理頁面後使用新版本",
	 "ui.native_plugin_update_requires_a_full_cpa_restart": "原生外掛程式更新後必須完整重新啟動 CPA；僅重新整理頁面或刪除舊檔案不會停止記憶體中的舊實例",
	 "ui.runtime_ownership_storage_is_unavailable": "單一實例執行狀態無法持久化，背景自動化已安全停用，請檢查 data_dir 寫入權限",
	 "ui.restart_cpa_to_enable_this_plugin_instance_s_background_automation": "目前修復版正在等待首次 CPA 重新啟動，重新啟動前不會開始新的巡檢、自動處置或外部通知",
